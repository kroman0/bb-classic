...
COLLECTION = [{
    ...
    "category-id": i % 5 + 1,
    "city": "City #%s" % i,
    "commented-at": "%d-%.2d-%.2d" % (i % 12 + 2001,
                                  i % 12 + 1,
                                  i % 30 + 1),
    "comments-count": i,
    "company": {
    ...
    "completed-at": "%d-%.2d-%.2d" % (i % 12 + 2001,
                                  i % 12 + 1,
                                  i % 30 + 1),
    ...
    "country": "Country #%s" % i,
    "created-at": "%d-%.2d-%.2d" % (i % 12 + 2001,
                                i % 12 + 1,
                                i % 30 + 1),
    "created-on": "%d-%.2d-%.2d" % (i % 12 + 2001,
                                i % 12 + 1,
                                i % 30 + 1),
    "creator-id": i % 5 + 1,
    "creator-name": "Creator name #%s" % i,
    "date": "%d-%.2d-%.2d" % (i % 12 + 2001, i % 12 + 1, i % 30 + 1),
    "deadline": "%d-%.2d-%.2d" % (i % 12 + 2001,
                              i % 12 + 1,
                              i % 30 + 1),
